...
*/
int StringCutStreams(struct CommandLine **line, struct String *str, int *i, int *j /*number of line in pack of lines*/)
{	
	int size = StringSize(str);
	if (StringCharAt(str,*i) == '>' && (*i < size) && StringCharAt(str,*i+1) == '>')
	{
